...
for rlzInd=1:RlzS
    ...
    for blInd=1:length(bLenVec)
        ...
        for spInd=1:length(spVec)
            ...
            [recErrNormL1min(:,rlzInd,blInd,spInd),recErrNormBP(:,rlzInd,blInd,spInd)]=OneStepQNCCapsule(iterations,nodes,edges,DeltaQ,htList,x,GWnode,phi,sigmaBig,numWdIters,sparsityFactor,sigmaQ);
